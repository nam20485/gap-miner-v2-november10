...
<instructions>
  ...
  <template_usage>
    <summary>
      This repository is a **project instance** cloned from the `intel-agency/ai-new-workflow-app-template` GitHub template (`nam20485/gap-miner-v2-november10`).
    ...
    <creation_workflow>
      ...
      <step>2. That delegates to `./scripts/create-repo-with-plan-docs.ps1` which:
        - Creates a new GitHub repo from this template via `gh repo create --template nam20485/gap-miner-v2-november10`
        ...
        - Replaces all template placeholders (`gap-miner-v2-november10` → new repo name, `nam20485` → new owner)
    ...
    <template_design_constraints>
      <rule>Template placeholders (`gap-miner-v2-november10`, `nam20485`) in file contents and paths are replaced by the creation script. Keep them consistent.</rule>

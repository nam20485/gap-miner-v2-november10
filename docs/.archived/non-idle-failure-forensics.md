...
> **Affected targets:**
> - `nam20485/gap-miner-v2-november10` run `23415797162` (2026-03-23)
...
|---|------|--------|------------|---------------|-----------------|-------------------------|
| 1 | `nam20485/gap-miner-v2-november10` | `23415797162` | 2026-03-23 00:07 | Token validation failure | `GH_ORCHESTRATION_AGENT_TOKEN is missing required scopes: read:org` | Same-repo run rejected a narrower-but-usable token path instead of falling back to `GITHUB_TOKEN` |
...
- Workflow run `23415797162` logs (`nam20485/gap-miner-v2-november10`)

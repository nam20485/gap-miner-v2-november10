...
This document defines the comprehensive development plan for Feature F1: migrating all orchestration-related code from the template repository (`nam20485/gap-miner-v2-november10`) to a dedicated prebuild container repository (`nam20485/workflow-orchestration-prebuild`).
...
```
┌─────────────────────────────────────────────────────────────────────────────┐
│                    TEMPLATE REPO (gap-miner-v2-november10)             │
│                                                                             │
│  ┌─────────────────────────────────────────────────────────────────────┐   │
...
| Requirement | Details |
|-------------|---------|
| Verify replacement logic | `create-repo-with-plan-docs.ps1` currently replaces `gap-miner-v2-november10` |
...
| Template Repo | https://github.com/nam20485/gap-miner-v2-november10 |

...
**Locations to update:**
- The orchestrator prompt template in `gap-miner-v2-november10` (e.g., `scripts/prompt.ps1`, `orchestrator-supervisor.md`, or the assembled prompt).
...
| Orchestrator prompt (TBD exact file) | gap-miner-v2-november10 | Define 4-step loop |
